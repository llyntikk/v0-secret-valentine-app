...
function CountdownToValentine() {
  ...
  useEffect(() => {
    function calc() {
      ...
      if (now > valentine) valentine = new Date(now.getFullYear() + 1, 1, 14)
  ...
  return (
    ...
    >
      <Clock className="h-3.5 w-3.5 text-[#ff4d6d]" />
...
export function HeaderSection({
  ...
  return (
    <div className="relative overflow-hidden">
      {/* Gradient banner */}
      <div
        className="absolute inset-0 h-60 animate-gradient-shift"
        style={{
          background: "linear-gradient(135deg, #800f2f, #c9184a, #590d22, #800f2f)",
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle at 20% 80%, rgba(255,77,109,0.25) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(128,15,47,0.4) 0%, transparent 50%)",
        }}
      />
      <div
        className="absolute inset-0 h-60"
      ...
      >
        ...
        >
          <div
            ...
            style={{ background: "linear-gradient(135deg, #800f2f, #ff4d6d, #800f2f)" }}
          >
        ...
        <div className="flex flex-col items-center gap-2">
          <h1 className="text-2xl font-extrabold text-white tracking-tight text-balance text-center">
            {"Отправляй и получай валентинки!"}
          </h1>
          <motion.span
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <Heart className="h-3 w-3 fill-current text-[#ff4d6d]" />
            {"Тайный Валентин"}
          </motion.span>
        </div>
        ...
        <div className="flex items-center gap-3 flex-wrap justify-center">
          ...
          >
            <Heart className="h-4 w-4 fill-[#ff4d6d] text-[#ff4d6d] animate-heartbeat" />
        ...
        >
          <div className="mb-1 flex items-center justify-between">
            ...
            <span className="text-[11px] font-bold text-[#ff4d6d]">{progressPercent}%</span>
          </div>
